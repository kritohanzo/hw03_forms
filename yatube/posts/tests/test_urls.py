...
class StaticURLTests(TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.user_not_author = User.objects.create_user(username='post_not_author')
    ...
    def test_post_uses_correct_templates(self):
        ...
        for url, template in url_templates.items():
            with self.subTest(url=url):
                ...
                self.assertTemplateUsed(response, template, f'Страница {url} показывает не правильный шаблон')
